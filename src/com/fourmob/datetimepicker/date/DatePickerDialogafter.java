...
public class DatePickerDialogafter extends DialogFragment implements
	...
	public DatePickerDialogafter() {
		// Empty constructor required for dialog fragment. DO NOT REMOVE
	}

	public static DatePickerDialogafter newInstance(
	...
	public static DatePickerDialogafter newInstance(
			OnDateSetListener onDateSetListener, int year, int month, int day,
			boolean vibrate) {
		DatePickerDialogafter datePickerDialog = new DatePickerDialogafter();
	...
	public static abstract interface OnDateSetListener {
		public abstract void onDateSet(DatePickerDialogafter datePickerDialog,
